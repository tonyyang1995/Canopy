...
class ANNregressor():
    def __init__(self, configs):
        ...
        hidden_layer_sizes = configs["Model"]["hidden_layer_sizes"]
        max_iter = configs["Model"]["max_iter"]
        random_state = configs["seed"]
        tol = configs["Model"]["tol"]
    ...
    def load(self):
        if not os.path.exists(f"{self.save_path}/ann_regression.pkl"):
            print("Model checkpoint not found!")
            return 
        with open(f"{self.save_path}/ann_regression.pkl", "rb") as f:
